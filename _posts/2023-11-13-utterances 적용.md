...
![utterance](../image/utterance.png "Install Utterances"){: width="600"height="300"}
...
![setting](../image/utterance%20enter.png "Setting Utterances"){: width="500"height="300"}
...
![config_yml](../image/config.png "Setting config"){: width="600"height="150"}

**✨중요**  _config.yml 파일을 아래로 쭉 내리다보면 defaults 부분이 존재합니다
이 부분에서 comments 부분을 꼭 true로 설정해주세요
![default](../image/defaults.png "Setting defaults"){: width="400"height="240"}

이제 다 되었다면 Github에 push해주면 됩니다!

![commnet](../image/comment.png "comment"){: width="500"height="300"}
